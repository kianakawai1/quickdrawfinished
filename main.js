...
document.getElementById("sketchtobeDrawn").innerHTML= "draw: " + sketch;
console.log("elementOfArray: " + sketch);
...
function gotResult(error, results){
    ...
    console.log(results);
    document.getElementById("yourSketch").innerHTML = 'sketch: ' + results[0].label;
